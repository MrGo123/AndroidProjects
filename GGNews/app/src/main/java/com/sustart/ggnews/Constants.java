...
public final class Constants {
    ...
    public static String ALL_NEWS_PATH = "index";
    public static String GENERAL_NEWS_PATH = "generalnews/";
    public static String API_KEY = "4ab3c9cf367a88514428acdf504a2576";
    public static String ALL_NEWS_URL = SERVER_URL + ALL_NEWS_PATH;
    public static String GENERAL_NEWS_URL = SERVER_URL + GENERAL_NEWS_PATH + ALL_NEWS_PATH;
